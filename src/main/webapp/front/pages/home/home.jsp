              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  meishiList2" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../meishi/detail.jsp?id='+item.id)">
                                            <img :src="item.meishiPhoto?item.meishiPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.meishiName}}</p>
                                            <p style="color: red;" v-if="item.meishiNewMoney">{{item.meishiNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../meishi/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">博主推荐展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  meishiList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../meishi/detail.jsp?id='+item.id)">
                                            <img :src="item.meishiPhoto?item.meishiPhoto.split(',')[0]:''" width="300px" height="300px"/>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">个性美食展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  meishiList1" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../meishi/detail.jsp?id='+item.id)">
                                            <img :src="item.meishiPhoto?item.meishiPhoto.split(',')[0]:''" width="300px" height="300px"/>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">附近美食展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  meishiList3" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../meishi/detail.jsp?id='+item.id)">
                                            <img :src="item.meishiPhoto?item.meishiPhoto.split(',')[0]:''" width="300px" height="300px"/>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`meishi/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 0
        }, function (res) {
            vue.meishiList = res.data.list;
        });
        http.request(`meishi/list`, 'get', {
            page: 1,
            limit: 6,
