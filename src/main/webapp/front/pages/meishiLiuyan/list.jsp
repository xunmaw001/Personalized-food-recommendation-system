            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">美食留言展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../meishiLiuyan/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.meishiLiuyanPhoto?item.meishiLiuyanPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../meishiLiuyan/detail.jsp?id='+item.id)"><span>{{item.meishiLiuyanName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 meishiLiuyanContent 字段去除无用字符 如果字段长度大于60  就截取到60
            meishiLiuyanContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                        // 获取列表数据
            http.request('meishiLiuyan/list', 'get', param, function(res) {
