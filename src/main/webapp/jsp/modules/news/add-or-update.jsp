    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑博主推荐</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">博主推荐管理</li>
                        <li class="breadcrumb-item active">编辑博主推荐</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">博主推荐信息</h3>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                newsName: "博主推荐名称不能为空",
                newsPhoto: "博主推荐图片不能为空",
                insertTime: "博主推荐时间不能为空",
                newsContent: "博主推荐详情不能为空",
            }
        }).form();
    }
